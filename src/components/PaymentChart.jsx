...
const ChartSkeleton = () => (
 ...
 >
  ...
  {/* Chart bars skeleton */}
  <Box sx={{ display: "flex", alignItems: "flex-end", gap: 2, height: 340, px: 4, pb: 4 }}>
   ...
   >
    ...
    <Box sx={{ width: "100%", height: { xs: 360, md: 420 } }}>
     <BarChart
      ...
      margin={{ top: 40, right: 20, bottom: 80, left: 65 }}
    ...
    >
     ...
     <Typography sx={{ fontSize: "0.75rem", color: "#94a3b8" }}>
      UPI and Cash are the top performing payment modes this month.
     </Typography>
    </Box>
   </Box>
